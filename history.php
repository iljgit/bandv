...
<html lang="en">
    ...
    <body onload="BandV.onload();">
        ...
        <!-- Banner image -->
        <div class="container-fluid parallax banner" style="background-image: url(/assets/img/history/header.jpg);">
            <h1 id="title"><span class="title-background">History of the Society</span></h1>
        </div>
