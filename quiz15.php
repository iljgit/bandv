...
<html lang="en">
        ...
        <script>
            ...
            function quiz() {
                ...
                if (doIt) {
                    ...
                    PFModal.showStaticPopup({type: 'quizok', date: '15 January 2022'});
                    $.ajax({
                        type: "GET",
                        url: url,
                        data: ''
    ...
    <body onload="BandV.onload(); PFModal.init();" class="past">
        ...
        <!-- Banner image -->
        <div class="container-fluid parallax banner" style="background-image: url(/assets/img/quiz/quiz15/header.jpg);">
            <h1 id="title"><span class="title-background">Quiz #15</span></h1>
        </div>
        ...
        <div class="container" id="pagebody">
            ...
            <div class="row mb" id="home">
                ...
                <div class="col-12">
                    <h2>Paint or Porn</h2>
                    <p>The word cloud below contains the names of 10 current or recent shades of Dulux paint, and 10 popular (apparently) adult films.</p>
                    <p>All you have to do is record the names of the 10 <b>adult films</b>.  Do not enter more than 10 answers.</p>
                    <p>You will get one point for every correct answer, and lose one point for every incorrect one.
            ...
            <div class="row mb">
                <div class="col-12 col-md-8">
                    <h5>The Word Cloud</h5>
                    <p>
                        <img alt="word cloud" src="/assets/img/quiz/quiz15/wordcloud.jpg" style="width: 100%;" />
                    </p>
                </div>
