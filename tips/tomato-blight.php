...
<html lang="en">
  <head>
    ...
    <meta name="description" content="Tomato Blight - Burnside and Vinery Road Allotment Society">
    <meta name="author" content="">
    <META HTTP-EQUIV="Pragma" CONTENT="no-cache">
    <META HTTP-EQUIV="Expires" CONTENT="-1">
    <link rel="shortcut icon" href="/assets/ico/favicon.ico">

    <title>Burnside and Vinery: Tomato Blight</title>
	 ...
	 <div class="container">
            ...
            <div class="row">
                <div class="col-xs-12">
                    ...
                    <p class="large-text"><img src="/tips/images/tomato-blight.jpg" class="pull-left img-responsive img-thumbnail margin" style="width:25%">
...
<figure class="figure pull-right margin" style="width:25%; margin-left: 10px; margin-bottom: 10px;">
  <img src="/tips/images/crimson-crush.jpg" class="figure-img img-fluid img-responsive img-thumbnail pull-right" style="width: 100%">
  <figcaption class="figure-caption text-right" style="font-size: 80%"><i>Crimson crush</i></figcaption>
</figure>
<p class="large-text">
