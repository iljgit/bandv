...
<html lang="en">
    ...
    <body onload="BandV.onload();">
        ...
        <!-- Banner image -->
        <div class="container-fluid parallax banner text-center" style="background-image: url(/assets/img/blog/trevor-taylor/dedication/D71_6814.jpg);">
            <h1 id="title"><span class="title-background">Trevor Taylor - a force of nature</span></h1>
        </div>
        ...
        <div class="container" id="pagebody">
            ...
            <div class="row mb" id="home">
                ...
                <div class="col-12">
                <p>This blog is a tribute to Trevor Taylor, Honorary President of the Society. He passed away in September 2018, having had an association with allotments 
                of over 50 years at local and national level. We will add snippets about Trevor and his allotment activities to this page from time to time, 
                largely drawn from the extensive allotment-related papers he compiled and kept over the years.</p>
            ...
            <div class="row mb">
                ...
                <img src="/assets/img//blog/trevor-taylor/trevor2.jpg" class="img-thumbnail img-responsive" style="width: 40%; margin-bottom: 20px; float: right;">
            ...
            <div class="row mb">
                <div class="col-12">
                    <h2>Joan and Andy went to meet Trevor in 2017</h2>
                </div>
                <div class="col-12">
                <img class="img-thumbnail img-responsive" src="/assets/img/blog/trevor-taylor/trevor.jpg" style="width: 40%; margin-bottom: 20px; float: right;" />
