...
<html lang="en">
    ...
    <body onload="BandV.onload();">
        ...
        <!-- Banner image -->
        <div class="container-fluid parallax banner" style="background-image: url(/assets/img/blog/tomatoblight/header.jpg);">
            <h1 id="title"><span class="title-background">Tomato Blight</span><br><br><span class="byline">Barry, Vinery</span></h1>
        </div>
...
<figure class="figure pull-right margin" style="width:25%; margin-left: 10px; margin-bottom: 10px;">
  <img src="/assets/img/blog/tomatoblight/crimson-crush.jpg" class="figure-img img-fluid img-responsive img-thumbnail pull-right" style="width: 100%">
