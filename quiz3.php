...
<html lang="en">
  <head>
    ...
    <meta name="description" content="Burnside and Vinery Road Allotment Society Quiz - Christmas 2018">
    <meta name="author" content="">
    <META HTTP-EQUIV="Pragma" CONTENT="no-cache">
    <META HTTP-EQUIV="Expires" CONTENT="-1">
    <link rel="shortcut icon" href="assets/ico/favicon.ico">

    <title>Burnside and Vinery: Quiz, Christmas 2018</title>
