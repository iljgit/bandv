...
$wn[] = (object) [
    "date" => "13 Jan 2021",
    "text" => "Coronavirus advice on this page updated on 12<sup>th</sup> January 2021",
...
$wn[] = (object) [
    "date" => "18 Nov 2020",
    "text" => "Andy's vision for a new communal facility at Burnside - updated 18 Nov<br>All the groundworks are now complete!",
...
$wn[] = (object) [
    "date" => "30 Nov 2020",
    "text" => "A musical intros quiz",
    "link" => "<a href='/quiz12.php' title='Click for the quiz'><button class='btn btn-success'>More...</button></a>"
];

$wn[] = (object) [
    "date" => "23 Jan 2021",
    "text" => "The current tenancy agreements are now available online",
...
$wn[] = (object) [
    "date" => "07 May 2021",
    "text" => "Andy has been busy making progress with the Burnside Tearoom.",
    "link" => "<a href='/blog/tea-room.php' title='Click for details'><button class='btn btn-success btn-sm'>More...</button></a>"
];

$wn[] = (object) [
    "date" => "10 May 2021",
    "text" => "Just a reminder that the store is open 10-12 on Saturdays <b>and</b> Sundays in May - Saturdays only June and July",
    "link" => "<a href='#store' title='Click for details'><button class='btn btn-success btn-sm'>More...</button></a>"
];
...
$wn[] = (object) [
    "date" => "27 Dec 2021",
    "text" => "Just to keep you entertained (?) over the Christmas period, there will be a few quizzes, just for fun.  Number 2 is available now.",
...
$gallery->plotclearance202103 = (object) [
    ...
    "body" => "<p>Four half plots have recently been cleared ready for letting. A lot of metal and other debris has been removed and some trees have had to be cut down. 
     Many thanks are due to the Burnside site managers and willing volunteers for a lot of hard graft.</p>",
