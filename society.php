            ...
            <div class="row mb">
                <div class="col-12 col-sm-6 col-md-4 blog-summary-card">
                    <div class="card">
                        ...
                        <div class="card-footer"><a href="#documents" class='btn btn-success stretched-link'>More...</a></div>
                    </div>
                </div>
                ...
                <div class="col-12 col-sm-6 col-md-4 blog-summary-card">
                    <div class="card">
                        ...
                        <div class="card-footer"><a href="#committee" class='btn btn-success stretched-link'>More...</a></div>
                    </div>
                </div>
        ...
        <div class="row mb">
                <div class="col-xs-12  col-md-6" style="margin-bottom: 10px;">
                    ...
                    <blockquote class="blockquote">
                        <img class="img img-responsive img-rounded img-thumbnail pull-right margin" style="max-width: 40%;" src="/assets/img/society/committee/penny.jpg"/>
                    ...
                    <p class="large-text text-center"><a href="mailto:chair@burnsideandvineryallotments.org"><i class="fas fa-envelope"></i>&nbsp;chair</a>
                    </p>
                </div>
                ...
                <div class="col-xs-12 col-md-6"  style="margin-bottom: 10px;">
                    ...
                    <blockquote class="blockquote">
                        <img class="img margin img-responsive img-rounded thumbnail-lg pull-right" style="max-width: 40%;" src="/assets/img/society/committee/andy.jpg"/>
                    ...
                    <p class="large-text text-center"><a href="mailto:burnsidesitemanager@burnsideandvineryallotments.org"><i class="fas fa-envelope"></i>&nbsp;burnsidesitemanager</a>
                    </p>
                </div>
            </div>
            ...
            <div class="row mb" style="margin-bottom: 10px;">
                <div class="col-xs-12 col-md-6">
                    ...
                    <blockquote class="blockquote">
                        <img class="img margin img-responsive img-rounded img-thumbnail pull-right" style="max-width: 40%;" src="/assets/img/society/committee/mattheww.jpg"/> 
                    ...
                    <p class="large-text text-center"><a href="mailto:treasurer@burnsideandvineryallotments.org"><i class="fas fa-envelope"></i>&nbsp;treasurer</a>
                    </p>
                </div>
                ...
                <div class="col-xs-12 col-md-6" style="margin-bottom: 10px;">
                    ...
                    <blockquote class="blockquote">
                        <img class="img margin img-responsive img-rounded img-thumbnail pull-right" style="max-width: 40%;" src="/assets/img/society/committee/barry.jpg"/> 
                    ...
                    <p class="large-text text-center"><a href="mailto:vinery@burnsideandvineryallotments.org"><i class="fas fa-envelope"></i>&nbsp;vinery</a>
                    </p>
                </div>
            ...
            <div class="row mb" style="margin-bottom: 10px;">
                <div class="col-xs-12 col-md-6">
                    ...
                    <blockquote class="blockquote">
                    <img  class="img margin img-responsive img-rounded img-thumbnail pull-right" style="max-width: 40%;" src="/assets/img/society/committee/jba.jpg"/> 
                    ...
                    <p class="large-text text-center"><a href="mailto:webmaster@burnsideandvineryallotments.org"><i class="fas fa-envelope"></i>&nbsp;webmaster</a>
                    </p>
                </div>
                ...
                <div class="col-xs-12 col-md-6" style="margin-bottom: 10px;">
                    ...
                    <blockquote class="blockquote">
                    <img  class="img margin img-responsive img-rounded img-thumbnail pull-right" style="max-width: 40%;" src="/assets/img/society/committee/alexandra-tong.jpg"/> 
            ...
            <div class="row mb" style="margin-bottom: 10px;">
                ...
                <div class="col-xs-12 col-md-6" style="margin-bottom: 10px;">
                    ...
                    <blockquote class="blockquote">
                    <img class="img margin img-responsive img-rounded img-thumbnail pull-right" style="max-width: 40%;" src="/assets/img/society/committee/max.jpg"/> 
                ...
                <div class="col-xs-12 col-md-6" style="margin-bottom: 10px;">
                    ...
                    <blockquote class="blockquote">
                        <img class="img margin img-responsive img-rounded img-thumbnail pull-right" style="max-width: 40%;" src="/assets/img/society/committee/johnmcgill.jpg"/>
