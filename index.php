	 	...
	 	<div class="container large-text">
                    ...
                    <div class="row">
                        <div class="col-sm-12 col-md-6">
                            <img src="assets/img/pumpkins2019.jpg" class="img-responsive img-rounded" style="width: 100%;"/>
                            <p class="text-right"><i>All set for halloween.</i></p>
                        </div>
                        <div class="col-sm-12 col-md-6">
                    ...
                    <div class="row">
                        <div class="col-sm-12 col-md-6">
                            <img src="assets/img/harvest-barrow.jpg" class="img-responsive img-rounded" style="width: 100%;"/>
                            <p class="text-right"><i>How impressive is this?</i></p>
                        </div>
                        <div class="col-sm-12 col-md-6">
