...
<p>Not a cloud in the sky all day and barely a breath of wind, what a wonderful day to spend working together to help tidy and improve the allotment site for everyone. </p>`,       
        ...
        },
        {
         ...
         {
                title: "News of our Honorary President",
                id: 7,
                body: '<p>On Friday Feb 3rd Andy K and Joan from the committee met up with Trevor Taylor, our Honorary President, for a catch up at the Royal Standard on Mill Road. Trevor walked from his home (albeit with the aid of a walker), took little persuasion to partake in a couple of glasses of red wine, enjoyed a fish lunch and regretted not bringing a cigar! The conversation ranged widely. Non-allotment matters included Trevor’s ongoing love of jazz. Allotment matters included the annual seed buying scheme with King’s, which Trevor set up, even though the committee of the time were not in favour of the idea: it would be interesting to work out how much money the scheme has made for the Society over the years and how much members have saved on the cost of seeds.</p><p>Although few, if any, will remember that far back, most of the AGMs took place at the Royal Standard in the 1980s (as witness Trevor’s minutes, painstakingly written out by hand for many years). 1990s AGMs were mostly held at The Grasshopper nearby, although that no longer exists. We discovered that the Burnside site used to be referred to as the Perne Road site, as it was of course very much bigger once upon a time. And it was largely Trevor’s hard fought negotiation with the Council which prevented the Vinery Road site from losing much more land than it did to the building of St Philip’s School in 1984.</p><p>We also talked about the ‘Weeder’s Digest’ that Trevor produced periodically – <i>if anyone still has copies of this it would be great to see them</i>. The hints and tips section of our new website is now named ‘Weeder’s Digest’ (in Trevor’s honour and with his permission!) and we will also use his cookery section title ‘From Plot to Pot’ (again, with his permission) for recipes on the website. We hope very much to persuade Trevor to attend an allotment event later in the year, perhaps the summer barbecue, which, again, was something that he initiated.</p>',                
                date:  '09 Feb 2017',
                expires: '01 Feb 2018 00:00',
                images:[]
        },
        {
