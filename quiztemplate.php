    ...
    <body onload="BandV.onload(); PFModal.init();">
        ...
        <div class="container" id="pagebody">
            ...
            <div class="row mb" id="home">
                ...
                <div class="col-12">
                    <p>We are facing uncertain times, with lots to concern us.  But there is nothing that a good quiz can't make worse.  So, if you have an idle few minutes,
                        why not try your hand at our quiz.  It's just for fun and the results will be published on 01 Apr 2020, along with a randomly drawn winner.
                    </p>
                </div>
            ...
            <div class="row mb">
                <div class="col-12">
                    ...
                    <p>Here are 10 questions about bottoms in all the glorious meanings of that word.  
                        You can send us your answers (fill in your name, and press <i>Submit</i> if you would like to be included in our wall of fame / shame.
                    </p>
                </div>
            </div>
